...
Settings::Settings()
    ...
    , coverart_window_geometry(_settings, "coverart_window_geometry")
    ...
    , audio_library_view_visual_indexes(_settings, "audio_library_view_visual_indexes", QHash<QString, QVariant>())
    ...
    , details_splitter_sizes(_settings, "details_splitter_sizes", QVariantList())
